...
from hooks.hook_utils import graceful_main, log_event, is_hook_disabled
...
def get_handler(name: str):
    ...
    if name not in _handlers:
        if name == "context_monitor":
            from hooks.handlers.context_monitor import check_context
            _handlers[name] = check_context
        elif name == "usage_tracker":
            from hooks.handlers.usage_tracker import track_usage
